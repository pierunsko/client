...
public class TargetHudRenderer {
    ...
    public static void renderAresHUD(float normalizedDelta, float health, float animationFactor,
        ...
        GL11PushPop(() -> {
            ...
            fr.drawStringWithShadow(displayName, 0, 0, textCol.getRGB());
        });
        // "HP: X.X"
    ...
    public static void renderAlt1HUD(float normalizedDelta, float health, float animationFactor,
        ...
        GL11PushPop(() -> {
            ...
            mc.fontRendererObj.drawStringWithShadow(displayName, 0, 0, textCol.getRGB());
        });
    ...
    private static void renderItems(EntityPlayer target,
        ...
        List<ItemStack> armor = target.inventory.armorInventory;  // [0]=boots [3]=helmet
        ItemStack[] items = {
            target.getHeldItem(),       // main hand
            armor.get(3),               // helmet
            armor.get(2),               // chestplate
            armor.get(1),               // leggings
            armor.get(0),               // boots
